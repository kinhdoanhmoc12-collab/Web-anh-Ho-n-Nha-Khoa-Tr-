...
import { Image as ImageIcon, Plus, Trash2, CheckCircle2, RefreshCw, Eye, ArrowUp, ArrowDown } from "lucide-react";
      ...
      <main className="flex-1 p-6 sm:p-8 space-y-6 overflow-y-auto max-w-7xl">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-900 p-6 rounded-2xl border border-slate-800 shadow-xl">
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1">
              Thêm, chỉnh sửa, xóa và thay đổi thứ tự hình ảnh Banner trình chiếu trên Trang Chủ ZunPhoto.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-7 space-y-6">
            {/* Form Add */}
            <form onSubmit={handleAddBanner} className="bg-slate-900 p-5 rounded-2xl border border-slate-800 space-y-3 shadow-xl">
                ...
                {banners.map((url, idx) => (
                  ...
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      />
                      <span className="text-xs font-medium text-slate-300 truncate max-w-xs">{url}</span>
                    </div>
          ...
          {/* Live Preview Column */}
          <div className="lg:col-span-5 bg-slate-900 p-5 rounded-2xl border border-slate-800 space-y-4 shadow-xl h-fit">
            ...
            {banners.length > 0 ? (
              ...
              <div className="text-center py-12 text-slate-500 text-xs font-semibold">
                Chưa có ảnh banner nào. Vui lòng thêm ảnh banner mới!
              </div>
            )}
          </div>
        </div>
